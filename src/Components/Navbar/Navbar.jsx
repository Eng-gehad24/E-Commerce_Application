  ...
  <div className="container">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      {token?<ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li>
        <Link className={`path-Link ${location.pathname === '/allorders' ? 'color-main' : ''}`} aria-current="page" to="allorders">Cart</Link>
        </li>
      </ul>:''}
      ...
      <li>
        ...
        <li className="nav-item">
          <button className="btn SignOut fw-bold" onClick={checkForLogout}>LognOut</button>
        </li>
